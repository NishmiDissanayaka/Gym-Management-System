        ...
        <div class="form-card">
            ...
            <div class="form-card-header">
                <div class="form-card-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#e6a800" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/>
                    </svg>
                </div>
                <div>
                    <div class="form-card-title">Member Registration</div>
                    <div class="form-card-subtitle">Fields marked <span class="required">*</span> are required</div>
                </div>
            </div>
                                ...
                                <?php if ($plans && $plans->num_rows > 0): ?>
                                    <?php while ($plan = $plans->fetch_assoc()): ?>
                                        <option value="<?php echo $plan['type_id']; ?>">
                                            <?php echo htmlspecialchars($plan['type_name']); ?> — Rs. <?php echo number_format($plan['amount'], 2); ?>
                                        </option>
                                    <?php endwhile; ?>
                                <?php else: ?>
